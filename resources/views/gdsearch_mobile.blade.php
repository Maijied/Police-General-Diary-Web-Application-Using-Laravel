...
<script type="text/javascript">
    ...
    function validateForm() {
        var v = document.forms["myForm"]["gdsearch_sim"].value;
        ...
        var z = document.forms["myForm"]["gdsearch_imei1"].value;
        if (w == "" && x == "" && y == "" && z == "" && v=="") {
                ...
                <div class="col-md-8 col-md-offset-2">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                         ...
                         <form action="{{url('/')}}/gdsearchresult_mobile" method="post" onsubmit="return validateForm()" name="myForm">
                            {{csrf_field()}}


                            <font >Search By GD no:&emsp;&emsp; </font><input placeholder="" type="text" name="gdsearch_number"><br>
                            <font >Search By Sim no: &emsp;&ensp;</font><input placeholder="" type="text" name="gdsearch_sim"><br>
                            <font >Search By Mobile no: </font><input placeholder="" type="text" name="gdsearch_mobile"><br>
                            <font >Search By Imei-1 no: </font><input placeholder="" type="text" name="gdsearch_imei1"><br>
                            <font >Search By Name:&emsp;&emsp;&ensp; &ensp;</font><input placeholder="" type="text" name="gdsearch_v_name"><br>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{url('/')}}/get_mobile" method="get">
                                            {{csrf_field()}}
