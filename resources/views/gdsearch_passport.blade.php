...
<script type="text/javascript">
    ...
    var x = document.forms["myForm"]["gdsearch_passport"].value;
                ...
                <div class="col-md-8 col-md-offset-2">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                             ...
                             <form action="{{url('/')}}/gdsearchresult_passport" method="post" onsubmit="return validateForm()" name="myForm">
                            {{csrf_field()}}


                            <font >Search By GD no: &emsp; &emsp;&ensp;    </font><input placeholder="" type="text" name="gdsearch_number"><br>
                            <font >Search By Passport no: </font><input placeholder="" type="text" name="gdsearch_passport"><br>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        ...
                                        <form action="{{url('/')}}/get_passport" method="get">
                                            {{csrf_field()}}
