...
<script type="text/javascript">
    ...
    var x = document.forms["myForm"]["gdsearch_nid"].value;
    var y = document.forms["myForm"]["gdsearch_mobile"].value;
    var z = document.forms["myForm"]["gdsearch_v_name"].value;
    if (w == "" && x == "" && y == "" && z=="") {
                ...
                <div class="col-md-8 col-md-offset-2">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                          ...
                          <form action="{{url('/')}}/gdsearchresult_others" method="post" onsubmit="return validateForm()" name="myForm">
                            {{csrf_field()}}


                            <font >Search By GD no: &ensp;&emsp;&ensp;&ensp;</font><input placeholder="" type="text" name="gdsearch_number"><br>
                            <font >Search By NID no:&emsp;&ensp;&ensp; </font><input placeholder="" type="text" name="gdsearch_nid"><br>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{url('/')}}/get_others" method="get">
                                            {{csrf_field()}}
