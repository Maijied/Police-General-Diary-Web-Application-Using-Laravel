      ...
      <div class="row">   
        <div class="col-md-8 col-md-offset-2">
          <div class="panel panel-default">
            <div class="panel-heading"><div><b><font color="white">General Diary Box</font></b></div></div>

            <div class="panel-body">
             
              <img  class="smplogo"  src="http://localhost/police/public/img/smplogo.png">
              <p  align="center">
              সিলেট মেট্রোপলিটন পুলিশ,সিলেট</p>



              <form action="{{url('/')}}/insert_passport" method="post">
                {{csrf_field()}}
                বরাবর<br>
                ...
                জনাব<br>
                &emsp;&emsp;&emsp;যথাবিহীত সম্মান প্রদর্শন পূর্বক বিনীত নিবেদন এই যে, আমি নিম্নস্বাক্ষরকারী <input  type="text"                    name="v_name" placeholder="">
                জাতীয় পরিচয় পত্র নং <input type="text" name="nid" size="30" placeholder=""> 
                পিতাঃ <input  type="text" name="father" size="45" placeholder=""> মাতাঃ  <input type="text" name="mother" size="45" placeholder=""><br>
                ...
                <br>
                আপনার থানায় হাজির হইয়া এই মর্মে সাধারণ ডায়েরী করার আবেদন করিতেছি যে, গত<input type="text" name="lost_date"  placeholder=""> তারিখে আমার পাসপোর্ট যাহার নং-<input type="text" name="passport_number"  placeholder=""><b>| </b><input type="text" name="from_place"  placeholder="">হইতে <input type="text" name="to_place"  placeholder="">যাওয়ার পথে হারিয়ে যায়। অনেক খোঁজাখুঁজি করিয়াও আমার পাসপোর্টটি পাওয়া যায় নাই। এমতাবস্তায় উক্ত বিষয়ে সাধারণ ডায়েরী করিতে একান্ত ইচ্ছুক।
