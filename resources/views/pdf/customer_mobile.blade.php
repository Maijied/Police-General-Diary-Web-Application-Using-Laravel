...
বরাবর<br>
                ...
                জনাব<br>
                &emsp;&emsp;&emsp;যথাবিহীত সম্মান প্রদর্শন পূর্বক বিনীত নিবেদন এই যে, আমি নিম্নস্বাক্ষরকারী {{$key->v_name}}<br>
                জাতীয় পরিচয় পত্র নং {{$key->NID}} 
                পিতাঃ {{$key->father}} মাতাঃ  {{$key->mother}}<br>
                ঠিকানা (স্থায়ী) : {{$key->address_permanent}}<br>
                ঠিকানা (বর্তমান) : {{$key->address_present}}
                <br>
                আপনার থানায় হাজির হইয়া এই মর্মে সাধারণ ডায়েরী করার আবেদন করিতেছি যে, গত {{$key->lost_date}} <br>আমার ব্যবহৃত মোবাইল হ্যান্ডসেটটি যাহার মডেল নং {{$key->mobile_model}},  এবং {{$key->mobile_color}} রঙের।<br> যাহার  IMEI1-{{$key->imei1}} , IMEI2-{{$key->imei2}}| যাহার সংযোগ সীম নং- {{$key->sim}}
                {{$key->from_place}}

                হইতে {{$key->to_place}} যাওয়ার পথিমধ্যে হ্যান্ডসেটটি কোথায় যেন হারিয়ে যায়। অনেক খোঁজখুঁজি করিয়া পাওয়া যায় নাই। এমতাবস্থায় উক্ত বিষয়ে সাধারণ ডায়েরী করিতে ইচ্ছুক।
