...
বরাবর<br>
                ...
                <br>
                আপনার থানায় হাজির হইয়া এই মর্মে সাধারণ ডায়েরী করার আবেদন করিতেছি যে, গত{{$key->lost_date}} তারিখে আমার পাসপোর্ট যাহার নং-{{$key->passport_no}}<b>| </b>{{$key->from_place}}হইতে {{$key->to_place}} যাওয়ার পথে হারিয়ে যায়। অনেক খোঁজাখুঁজি করিয়াও আমার পাসপোর্টটি পাওয়া যায় নাই। এমতাবস্তায় উক্ত বিষয়ে সাধারণ ডায়েরী করিতে একান্ত ইচ্ছুক।
