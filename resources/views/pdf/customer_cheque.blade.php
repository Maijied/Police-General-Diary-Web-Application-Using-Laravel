...
?>
 ...
 বরাবর<br>
                ...
                জাতীয় পরিচয় পত্র নং {{$key->NID}}<br> 
                পিতাঃ {{$key->father}} মাতাঃ  {{$key->mother}}<br>
                ঠিকানা (স্থায়ী) {{$key->address_permanent}}<br>
                ঠিকানা (বর্তমান) {{$key->address_present}}
                <br>
                আপনার থানায় হাজির হইয়া এই মর্মে সাধারণ ডায়েরী করার আবেদন করিতেছি যে, গত {{$key->lost_date}} তারিখ {{$key->time_of_day}}
                 {{$key->from_place}} হইতে {{$key->to_place}} যাওয়ার পথে আমার সাথে থাকা আমার নামীয়<br>{{$key->bank_name}}সঞ্চয়ী হিসাব নং- {{$key->account_number}}এর একটি চেক বই যাহার পাতা নং- {{$key->start_page}}হইতে {{$key->end_page}}  <br>মোট {{$key->pages}} পাতা আমার অসাবধানতা বসত কোথায় যেন হারিয়ে যায়। সম্ভাব্য সকলস্থানে খোঁজাখুঁজি করে চেক বইটির কোন সন্ধান পাই নাই। বিষয়টি থানায় জিডি এন্ট্রি করা প্রয়োজন।
