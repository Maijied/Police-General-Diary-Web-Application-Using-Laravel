                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                          ...
                          <form action="{{url('/')}}/gdsearchresult_nid" method="post" name="myForm" onsubmit="return validateForm()">
                            ...
                            <font >Search By NID no:&emsp;&ensp; </font><input placeholder="" type="text" name="gdsearch_nid"><br>
                            <font >Search By Name:&emsp;&ensp;&emsp; </font><input placeholder="" type="text" name="gdsearch_v_name"><br>
