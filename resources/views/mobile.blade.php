        ...
        <div class="col-md-8 col-md-offset-2">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              <form action="{{url('/')}}/insert_mobile" method="post">
                {{csrf_field()}}
                বরাবর<br>
                ...
                <br>
                আপনার থানায় হাজির হইয়া এই মর্মে সাধারণ ডায়েরী করার আবেদন করিতেছি যে, গত<input type="text" name="lost_date"  placeholder=""> তারিখে আমার ব্যবহৃত মোবাইল হ্যান্ডসেটটি যাহার মডেল নং <input type="text" name="mobile_model"  placeholder=""><b>,  এবং </b><input type="text" name="mobile_color"  placeholder=""> রঙের। যাহার  IMEI1-<input type="text" name="imei1"  placeholder="">,IMEI2-<input type="text" name="imei2"  placeholder="">| যাহার সংযোগ সীম নং- <input type="text" name="lost_phone_number"  placeholder="">
                <input type="text" name="from_place"  placeholder="">

                হইতে <input type="text" name="to_place"  placeholder=""> যাওয়ার পথিমধ্যে হ্যান্ডসেটটি কোথায় যেন হারিয়ে যায়। অনেক খোঁজখুঁজি করিয়া পাওয়া যায় নাই। এমতাবস্থায় উক্ত বিষয়ে সাধারণ ডায়েরী করিতে ইচ্ছুক।


                <br> 

                আমি এই মর্মে জানাচ্ছি যে,
                <br><textarea rows="15" cols="70" name="c_info"></textarea><br>
