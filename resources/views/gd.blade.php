...
/*app-navbar-collapse{
    ...
    body{
        ...
        background-image: linear-gradient(rgba(0,0,0,0.6),rgba(0,0,0,0.6)),url(img/10.jpg);
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form action="{{url('/')}}/insert" method="post">
                                ...
                                বরাবর<br>
                                <p>অফিসার ইনচার্জ</p>
                                &emsp;কোতোয়ালি মডেল থানা, <br>&emsp; সিলেট মেট্রোপলিটন পুলিশ ,সিলেট।<br><br>
                                বিষয়ঃ সাধারন ডাইরী করার করার প্রসঙ্গে ।<br><br>

                                জনাব<br>
                                &emsp;&emsp;&emsp;আমি নিম্নস্বাক্ষরকারী (নাম)<input type="text"  class="pix" name="v_name" placeholder="">
                                জাতীয় পরিচয় পত্র নং <input type="text" name="nid" size="25" placeholder=""> <br>
                                পিতাঃ <input type="text" name="father" size="40" placeholder=""> মাতাঃ  <input type="text" name="mother" size="40" placeholder=""><br>
                                ঠিকানা (স্থায়ী) <input type="text" name="permanent_address" size="82"  placeholder=""><br>
                                ঠিকানা (বর্তমান) <input type="text" name="present_address" size="80" placeholder="">
                                <br>
                                আমি এই মর্মে জানাচ্ছি যে,
                                <br><textarea rows="20" cols="100" name="c_info"></textarea><br>
                                &emsp;&emsp;&emsp;&emsp;      অতএব, মহোদয় উপরোক্ত বিষয়টি আপনার থানায় সাধারণ ডাইরীভূক্ত করতে মর্জি হয় ।<br>
