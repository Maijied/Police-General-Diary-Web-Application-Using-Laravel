          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              <form action="{{url('/')}}/insert_bank" method="post">
                ...
                <br>
                আপনার থানায় হাজির হইয়া এই মর্মে সাধারণ ডায়েরী করার আবেদন করিতেছি যে, গত<input type="text" name="lost_date"  placeholder="">তারিখ <input type="text" name="time_of_day"  placeholder="">
                <!-- <b> --> বেলা <!-- <input type="text" name="passport_number"  placeholder=""><b>,  --><!-- </b> --><input type="text" name="from_place"  placeholder="">হইতে <input type="text" name="to_place"  placeholder="">যাওয়ার পথে আমার সাথে থাকা আমার নামীয়<input type="text"  class="pix" name="bank_name" placeholder="">সঞ্চয়ী হিসাব নং- <input type="text" name="account_number" size="25" placeholder="">এর একটি চেক বই যাহার পাতা নং- <input type="text" name="to_cheque"  placeholder="">হইতে <input type="text" name="from_cheque"  placeholder="">  মোট <input type="text" name="pages"  placeholder="">পাতা আমার অসাবধানতা বসত কোথায় যেন হারিয়ে যায়। সম্ভাব্য সকলস্থানে খোঁজাখুঁজি করে চেক বইটির কোন সন্ধান পাই নাই। বিষয়টি থানায় জিডি এন্ট্রি করা প্রয়োজন।
